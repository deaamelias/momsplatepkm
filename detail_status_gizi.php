...
// Query SQL untuk mengambil informasi riwayat status gizi
$query = "SELECT * FROM status_gizi WHERE user_id = $user_id ORDER BY tanggal_waktu DESC";
...
<div class="container mt-5">
    <h1 class="mb-4">Riwayat Status Gizi</h1>

    <!-- Tabel untuk menampilkan riwayat status gizi -->
